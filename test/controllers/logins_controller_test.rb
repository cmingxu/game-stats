...
class LoginsControllerTest < ActionController::TestCase
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post :create, login: { app_id: @login.app_id, country: @login.country, locale: @login.locale, login_at: @login.login_at, player_id: @login.player_id }
    end
  ...
  test "should update login" do
    patch :update, id: @login, login: { app_id: @login.app_id, country: @login.country, locale: @login.locale, login_at: @login.login_at, player_id: @login.player_id }
    assert_redirected_to login_path(assigns(:login))
  end
